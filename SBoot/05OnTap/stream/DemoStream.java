...
public class DemoStream {
  ...
  public static void filterOutChinese() {
    people
    .stream()
    .filter(p -> !p.getNationality().equals("USA"))
    .sorted(Comparator.comparing(Person::getName))
    .forEach(System.out::println);
  }
  ...
  public static void sortAge2() {
    System.out.println("Độ tuổi trong khoảng 20 đến 30 là: ");
    people
    .stream()
  ...
  public static void averageAge2() {
    Double result = people
    .stream()
    .collect(Collectors.averagingInt(Person::getAge));
    System.out.println("Tuổi trung bình tất cả mọi người là: " + result);
  }
  // Tuổi trung bình theo từng quốc tịch
  public static void averageAge3() {
  ...
  .stream()
      ...
      System.out.println("Tuổi trung bình theo quốc tịch: " + result);
}
